  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0a1124]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          className="absolute top-[40%] -right-[10%] w-[60%] h-[60%] bg-[#1A2A5B]/40 rounded-full blur-[100px] animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute -bottom-[10%] left-[20%] w-[50%] h-[50%] bg-[#2BB6A3]/10 rounded-full blur-[100px] animate-pulse"
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden p-8 sm:p-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-4">
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg
                    className="h-5 w-5 text-[#2BB6A3] group-focus-within:text-[#2BB6A3]/80 transition-colors"
            ...
            <div className="text-center">
              <Link
                to="/forgot-password"
                className="text-sm font-medium text-[#2BB6A3] hover:text-white transition-colors"
              >
